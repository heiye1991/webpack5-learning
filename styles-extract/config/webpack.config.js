...
const devMode = process.env.NODE_ENV === 'production' // 生产还是开发环境 生产使用MiniCssExtractPlugin，开发使用style-loader
...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.styl$/,
        use: [devMode ? 'style-loader' : MiniCssExtractPlugin.loader, 'css-loader', 'postcss-loader', 'stylus-loader']
      },
      // 图片打包
      {
